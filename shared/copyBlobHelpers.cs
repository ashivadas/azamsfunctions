...
namespace sharedutils
{
    public class CopyBlobHelpers
    {
        ...
        public static async Task<IAsset> CreateAssetFromBlob(CloudBlockBlob blob, string assetName, TraceWriter log,
                           CloudMediaContext _context, string _storageAccountName, string _storageAccountKey)

        {
            ...
            try
            {
                Task<IAsset> copyAssetTask = CreateAssetFromBlobAsync(blob, assetName, log, _context, _storageAccountName, _storageAccountKey);
               ...
               CloudMediaContext _context, string _storageAccountName, string _storageAccountKey)
        {
            ...
            CloudStorageAccount _destinationStorageAccount = new CloudStorageAccount(mediaServicesStorageCredentials, false);
            ...
            CloudMediaContext _context, string _storageAccountName, string _storageAccountKey)
        {
            ...
            try
            {
                Task<IAsset> copyAssetTask = CreateAssetFromBlobMultipleFilesAsync(blob, assetName, log, assetfilesAsset, _context, _storageAccountName, _storageAccountKey);
                newAsset = await copyAssetTask;
                log.Info($"Asset Copied : {newAsset.Id}");
            }
            catch (Exception ex)
